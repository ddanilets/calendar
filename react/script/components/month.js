...
var Month = React.createClass({
	...
	render: function() {
		...
		var days = calendar.itermonthdates(this.props.moment.year, this.props.moment.num).forEach(item,key,calendar.itermonthdates(this.props.moment.year, this.props.moment.num)) {
				{
				year: item.year,
